            ...
            <form action="" id="manage-order">
                ...
                <div class="bg-white" id='o-list'>
                            <div class="d-flex w-100 bg-dark mb-1">
                                <label for="" class="text-white"><b>N Orden</b></label>
        ...
        <div class="col-lg-8  p-field">
            ...
            <div class="card-footer bg-dark  border-primary">
                <div class="row justify-content-center">
                    ...
                    <div class="btn btn btn-sm col-sm-3 btn-primary" type="button" id="save_order">Pagar Después</div>
                </div>
            </div>
            </div>      			
        </div>
...
<div class="modal fade" id="pay_modal" role='dialog'>
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-primary btn-sm"  form="manage-order">Paga</button>
...
<script>
   ...
   $("#pay").click(function(){
    ...
    if($('#o-list tbody tr').length <= 0){
        alert_toast("Porfavor agrega al menos 1 producto primero",'danger')
        end_load()
        return false;
    }
