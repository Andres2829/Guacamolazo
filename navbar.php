...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=sales" class="nav-item nav-sales "><span class='icon-field'><i class="fa fa-list-alt "></i></span> Reporte de Ventas</a>
				<a href="index.php?page=sales_report" class="nav-item nav-sales_report "><span class='icon-field'><i class="fa fa-list-alt "></i></span> Reporte de Ventas - Detalle</a>
				...
				<a href="index.php?page=sales_report_p" class="nav-item nav-sales_report_p "><span class='icon-field'><i class="fa fa-list-alt"></i></span> Reporte de Productos y Ventas</a>
				<?php if($_SESSION['login_type'] == 1): ?>
